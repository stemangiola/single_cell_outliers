...
script_dir = "/stornext/Bioinf/data/bioinf-data/Papenfuss_lab/projects/ma.m/single_cell_outliers/R_scripts/COVID_19/"
...
all_command <- all_command %>% pull(command) %>% 
    prepend("CATEGORY=COVID_19\nMEMORY=30024\nCORES=4") %>% 
    write_lines(glue("{script_dir}COVID_19.makeflow"))
