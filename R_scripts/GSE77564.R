...
library(readr)
GSE77564_single_neuron_exp_txt <- read_csv("single_cell_database/GSE77564_single_neuron/data/GSE77564_single_neuron_exp.txt.gz")
...
# GSE77564_single_neuron_exp_txt %>% CreateSeuratObject() %>% saveRDS("GSE77564_single_neuron/data/GSE77564.rds")
