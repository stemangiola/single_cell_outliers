...
script_dir = "/stornext/Bioinf/data/bioinf-data/Papenfuss_lab/projects/ma.m/single_cell_outliers/R_scripts/SCP1288_renal_cell_carcinoma/"
data_dir = "/stornext/Bioinf/data/bioinf-data/Papenfuss_lab/projects/ma.m/single_cell_outliers/single_cell_database/SCP1288_renal_cell_carcinoma/data/"
...
# DE analysis ------------------------------------------------------------------------------
# filtered_files = list.files(path = glue("{data_dir}filtered_data/"))
...
# command_filter %>% pull(command) %>% 
all_command %>% pull(command) %>%
    prepend("CATEGORY=SCP1288\nMEMORY=30024\nCORES=4") %>% 
    write_lines(glue("{script_dir}SCP1288.makeflow"))
