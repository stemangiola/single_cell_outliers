...
data_dir = "/stornext/HPCScratch/home/ma.m/single_cell_database/GSE120575_melanoma/data/"
...
data_exp = read.table(glue("{data_dir}GSE120575_Sade_Feldman_melanoma_single_cells_TPM_GEO.txt.gz"), 
                      sep = "\t", header = F, row.names = 1, stringsAsFactors = F, skip = 2)
