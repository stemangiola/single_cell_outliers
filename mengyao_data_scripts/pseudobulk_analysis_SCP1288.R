# Pesudobulk analysis for # Pesudobulk for SCP1288_renal_cell_carcinoma
...
setwd("/stornext/General/scratch/GP_Transfer/single_cell_database_papenfuss")
counts =
  readRDS(
    "/stornext/General/scratch/GP_Transfer/single_cell_database_papenfuss/SCP1288_renal_cell_carcinoma.rds"
  ) %>%
  tidysc::aggregate_cells(c(sample, cell_type), slot = "counts")  # 34 distinct cell types
