...
script_dir = "/stornext/HPCScratch/home/ma.m/mengyao_data_scripts/COVID_19/DE_analysis/"
input_dir = "/stornext/HPCScratch/home/ma.m/single_cell_database/COVID_19/data/all_raw_data/"
output_dir = "/stornext/HPCScratch/home/ma.m/single_cell_database/COVID_19/data/de_data/"

files = list.files(path = glue("{input_dir}"))
cell_name = tools::file_path_sans_ext(files) %>% basename() %>% str_replace_all("_raw","")
