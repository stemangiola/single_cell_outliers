...
in_dir = "/stornext/HPCScratch/home/ma.m/single_cell_database/GSE129788_aging_mouse_brain/data/de_data/" # path to data
...
density_plot <- df %>% 
    ...
    scale_x_log10() +
    ggtitle("Density plot for 21 cell types of dataset (GSE129788)") +
    custom_theme 

density_plot %>% ggsave(filename = "Density_plot.pdf", 
                        path = "/stornext/HPCScratch/home/ma.m/single_cell_database/GSE129788_aging_mouse_brain/plot/",
...
PCA_plot <- df_for_PCA %>% 
    ...
    facet_wrap(~ cell_type) +
    ggtitle("PCA plot for 21 cell types for dataset (GSE129788)") +
    custom_theme
...
#####------------------------------------------------------------------------------------------------------------
# 
# # generate histogram of TMM for samples
# df_for_PCA %>% ggplot(aes(x = TMM)) +
#     geom_histogram(bins = 30) +
#     facet_wrap(~cell_type, scales = "free") +
#     ggtitle("Histogram of TMM for samples")
# 
# # generate histogram of multiplier for samples
# df_for_PCA %>% ggplot(aes(x = multiplier)) +
#     geom_histogram(bins = 30) +
#     facet_wrap(~cell_type, scales = "free") +
...
sum_table <- readRDS("/stornext/HPCScratch/home/ma.m/single_cell_database/GSE129788_aging_mouse_brain/data/final_sum_table/sum_table.rds")
...
sum_table <- sum_table %>% pivot_longer(cols = c(transcript, de_genes, genes_with_outliers, outliers_in_top_PValue),
                                        names_to = "variable",
                                        values_to = "Count")
sum_table %>% saveRDS("/stornext/HPCScratch/home/ma.m/single_cell_database/GSE129788_aging_mouse_brain/data/final_sum_table/sum_table_for_bar_plot.rds")
# draw bar plot
...
bar_plot = sum_table %>% ggplot(aes(x = variable, y = Count,fill = variable)) +
    ...
    ggtitle("summary table of dataset (GSE129788)")
...
ppcseq_dir = "/stornext/HPCScratch/home/ma.m/single_cell_database/GSE129788_aging_mouse_brain/data/ppcseq_data/"
...
data_for_volanco %>% saveRDS("/stornext/HPCScratch/home/ma.m/single_cell_database/GSE129788_aging_mouse_brain/data/final_sum_table/dataframe_for_volcano.rds")
# No transcripts embedded with outliers
